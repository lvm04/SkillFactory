...
{
    /// <summary>
    /// Запрашивает у парсера тип команды и формирует ответ
    /// </summary>
    public class Messenger
    {
        ...
        private void RegisterCommands()
        {
            ...
            parser.AddCommand(new DictionaryCommand());
            parser.AddCommand(new AddWordAtOnceCommand());
        }
